...
const PATHS: Record<string, string> = {
  ...
  // An open book: print-book projects headed for KDP.
  books: 'M12 6.5c-1.5-1.3-3.5-2-6-2v13c2.5 0 4.5.7 6 2 1.5-1.3 3.5-2 6-2v-13c-2.5 0-4.5.7-6 2zM12 6.5v13',
...
export const Sidebar = (props: {
  ...
  const nav = [
    ...
    { href: active ? `/dashboard/books?t=${active.slug}` : '/dashboard/books', label: 'Books', icon: 'books', match: /\/dashboard\/books/ },
